#pragma checksum "/Users/trevormullaney/Documents/CS472/repo/seniorprojectfall2019team9/SightWordsProject/Views/Student/Stage1.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "40874dff90d41bd9919e488c10b4028df5e8150d"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"40874dff90d41bd9919e488c10b4028df5e8150d", @"/Views/Student/Stage1.cshtml")]
...
<div class=""showcase"">
  ...
  <div class=""project"">
    <img class=""project-img"">
      <div class");
            WriteLiteral(@"=""centered""><h4 id = ""box4"">4th word</h4></div>
    <span class=""project-name"">Drag to the Basket!</span>
  </div>
...
var model = ");
            EndContext();
            BeginContext(5070, 31, false);
#line 256 "/Users/trevormullaney/Documents/CS472/repo/seniorprojectfall2019team9/SightWordsProject/Views/Student/Stage1.cshtml"
       Write(Html.Raw(Json.Serialize(Model)));

#line default
#line hidden
            EndContext();
            BeginContext(5101, 4659, true);
            WriteLiteral(@";
var words = [];
...
const stopped = () => {
  ...
  if (dropped) {
    ...
    showcase.classList.");
            WriteLiteral(@"remove(""is-preview"");
...
function score_f(){
  score = score + 1;
 ");
            WriteLiteral(@" document.getElementById(""myScore"").innerHTML = ""My Score: "" + score;
}
function shuffle(a) {
    var j, x, i;
...
function wordGenerator(){
    ...
    //j=j+4;
    ");
            WriteLiteral(@"if(x > words.length){
